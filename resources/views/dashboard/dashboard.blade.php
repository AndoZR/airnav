...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="{{ asset('src/assets/compiled/svg/logo.svg') }}" alt="Logo" srcset=""></a>
            </div>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset('src/assets/compiled/jpg/5.jpg') }}">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset('src/assets/compiled/jpg/2.jpg') }}">
                                                    </div>
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ asset('src/assets/compiled/jpg/4.jpg') }}">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ asset('src/assets/compiled/jpg/1.jpg') }}">
                        </div>
                        <div class="name ms-4">
